 ...
 */
function createMeetingSchedulingOrg(): Organization {
  return {
    id: 'test-org',
    name: 'Ada Test Corp',
 ...
 */
function createMeetingSchedulingRubric(): EvaluationRubric {
...
export {
  runMeetingSchedulingEvaluation,
  demonstratePiperIntegration,
  createMeetingSchedulingRubric,
  basicMeetingScenario,
  groupMeetingScenario,
